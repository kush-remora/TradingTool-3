...
data class WeeklyPatternResult(
    ...
    val weeklyBaseConsistencyPct: Double? = null,
    val avgWeeklyRocPct: Double? = null,
    val volumeSignatureRatio: Double? = null,
    val mondayStrikeRatePct: Double? = null,
    val lastWeekMondayDipPct: Double? = null,
    val avg8wMondayDipPct: Double? = null,
    val mondayDipSamples8w: Int = 0,
