...
data class BollingerSqueezeScanResult(
    ...
    val filter1OriginPrice: Double?,
    val filter2Passed: Boolean,
    val filter2OriginDate: String?,
    val filter2LatestDate: String?,
    val filter2OriginPrice: Double?,
    val filter2MovePctFromFilter1: Double?,
    val filter2Type: String?,
    val alertStatus: String,
    val trendPatternFromFilter1: String?,
    val trendOverallFromFilter1: String?,
    val trendNetMovePctFromFilter1: Double?,
