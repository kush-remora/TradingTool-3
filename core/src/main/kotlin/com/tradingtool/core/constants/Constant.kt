...
object DatabaseConstants {
    ...
    object Tables {
        ...
        const val STOCK_FUNDAMENTALS_DAILY = "stock_fundamentals_daily"
    ...
    object TradeColumns {
        ...
        const val ALL = "$ID, $STOCK_ID, $NSE_SYMBOL, $QUANTITY, $AVG_BUY_PRICE, $TODAY_LOW, $STOP_LOSS_PERCENT, $STOP_LOSS_PRICE, $NOTES, $TRADE_DATE, $CLOSE_PRICE, $CLOSE_DATE, $STRATEGY, $CREATED_AT, $UPDATED_AT"
    }
    ...
    object StockFundamentalsColumns {
        const val STOCK_ID = "stock_id"
        const val INSTRUMENT_TOKEN = "instrument_token"
        const val SYMBOL = "symbol"
        const val EXCHANGE = "exchange"
        ...
        const val COMPANY_NAME = "company_name"
        const val MARKET_CAP_CR = "market_cap_cr"
        const val STOCK_PE = "stock_pe"
        const val ROCE_PERCENT = "roce_percent"
        const val ROE_PERCENT = "roe_percent"
        const val PROMOTER_HOLDING_PERCENT = "promoter_holding_percent"
        const val BROAD_INDUSTRY = "broad_industry"
